window._CCSettings = {
    ...
    rawAssets: {
        assets: {
            "47pc1OtQZICoOZeXiW20oB": [
                "res/audios/flattening.mp3",
                2
            ],
            "b1o+CJiiVH64YEWYBCCyl0": [
                "res/audios/jump.mp3",
                2
            ],
            "cdGYnWcZVBlpmdMmxM0UXg": [
                "res/audios/whatarewords.mp3",
                2
            ],
            "4b2aHgBplAToFG1IFGo83t": [
                "res/rextures/bg.jpg",
                0
            ],
            "459szqm1JJuraVyhvWF8kv": [
                "res/rextures/block1.png",
                0
            ],
            "c7Qs9oQy5Df7ReTEw6Qhly": [
                "res/rextures/block2.png",
                0
            ],
            "73sJbErt1L47OrpL6Zt3Go": [
            ...
            "089Ko9VqtAn5UIVFg0Ks3u": [
                "res/rextures/particle_texture.png",
                0
            ],
            "96kozNy45GY7PFNqzf6fA2": [
                "res/rextures/piece.png",
                0
            ],
            "42z5rKtvhDyLeUlLwC2Eov": [
                "res/rextures/restart_btn.png",
                0
            ],
            "7fDO3O8E1PCaab6lYI0p4P": [
                "res/rextures/start_btn.png",
                0
            ],
    ...
    launchScene: "db://assets/res/scenes/menu.fire",
    scenes: [
        {
            url: "db://assets/res/scenes/menu.fire",
            uuid: 3
        },
        {
            url: "db://assets/res/scenes/game.fire",
            uuid: 0
        }
    ],
    packedAssets: {
    ...
    uuids: [
        "33VomX/5xOGLemLEXossKM",
        "7bWFQTeX5PTqRWy4jrTR+F",
        "a2MjXRFdtLlYQ5ouAFv/+R",
        "f0UsO+Iv5NV5dAy545HZ6u"
    ],
    "md5AssetsMap": {
        "01/016316718.json": "d5248",
        "04/042ee5c41.json": "2efe2",
        "assets/res/audios/flattening.mp3": "5348f",
        "assets/res/audios/jump.mp3": "480ba",
        "assets/res/audios/whatarewords.mp3": "394b4",
        "assets/res/rextures/bg.jpg": "e7b3b",
        ...
        "internal/particle/atom.plist": "ca868"
    }
};